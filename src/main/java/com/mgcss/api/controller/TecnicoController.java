...
public class TecnicoController {
    ...
    /**
     * Endpoint para alternar el estado de un técnico (activo/inactivo). Si el técnico está activo, se inactivará, y viceversa. Si el técnico no existe, se lanzará una excepción que será manejada para devolver un error 404.
     * @param id ID del técnico cuyo estado se desea cambiar.
